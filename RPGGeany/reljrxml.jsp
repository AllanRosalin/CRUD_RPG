...
<body>
       ...
       <%
        ...
        String fsql = "";
	     ...
	     try
    	{
    		String url = "jdbc:sqlite:\\xampp\\tomcat\\webapps\\RPGGeany\\banco\\RPG.db";
			...
			JasperReport report = null;
     		...
     		report = JasperCompileManager.compileReport("C:\\xampp\\tomcat\\webapps\\RPGGeany\\relRPG.jrxml");  
  ...
  location.href = 'http://localhost:8080/RPGGeany/RPGgeany.jsp'
  </script>
</body>
</html>
