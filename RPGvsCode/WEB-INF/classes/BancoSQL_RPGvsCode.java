...
public class BancoSQL_RPGvsCode
{
   ...
   public static void conectar()
   {
	...
	public static void adicionar(RPGvsCode r)
	{
	...
	public static void altera(RPGvsCode rp)
	{
	...
	public static void remove(RPGvsCode rpg)
	{
	...
	public static boolean procura(RPGvsCode rg)
	{
		boolean flag = false;
	...
	public static ArrayList<RPGvsCode> getLista()
	{
		try {
			ArrayList<RPGvsCode> vetor = new ArrayList<RPGvsCode>();
			pstmt = con.prepareStatement("select * from table_rpg");
			rs = pstmt.executeQuery();
			while (rs.next())
			{
				// criando o objeto Contato
				RPGvsCode g = new RPGvsCode();
	...
	{  
		BancoSQL_RPGvsCode b = new BancoSQL_RPGvsCode("RPG.db");
        b.conectar();
        //b.gravandotxt();
        b.lendotxt();
        b.desconectar();
        
        ArrayList<RPGvsCode> listar = new ArrayList<RPGvsCode>();
        listar = b.getLista();
