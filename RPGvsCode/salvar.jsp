...
<body background="unesp.jpg">
	...
	<%@page language="Java" import="database.BancoSQL_RPGvsCode"%>
	<%@page language="Java" import="database.RPGvsCode"%>
	<%@page language="Java" import="java.util.Base64" %>
       ...
       <%
		...
		String caminhofoto="c://xampp//tomcat//webapps//RPGvsCode//fotos//"+nomefoto;
		...
		BancoSQL_RPGvsCode.conectar();
		BancoSQL_RPGvsCode.adicionar(rrr);
		BancoSQL_RPGvsCode.desconectar();
      %>
...
<form action="RPGvscode.jsp" method="get">
